...
from pypeh.adapters.export.xlsx import ExportXlsxAdapter

STUDYINFO_HEADERS = [
    "THIS INFORMATION IS PROVIDED BY PARC DATA MANAGEMENT TEAM",
    "...2",
    "...3",
]
CODEBOOK_METADATA = {
...
class TestExportXlsx:
    ...
    def test_export_data_template(self, monkeypatch):
        ...
        monkeypatch.setenv(
            ...
            get_absolute_path("./input/data_template"),
        )
        session = Session()
        ...
        with tempfile.TemporaryDirectory() as tmp:
            output_path = os.path.join(
                tmp, "test_export_data_template_result.xlsx"
            )
