...
class Observation(NamedThing):
    ...
    observation_results: Optional[Union[Union[str, ObservationResultId], List[Union[str, ObservationResultId]]]] = (
        empty_list()
    )
    ...
    def __post_init__(self, *_: List[str], **kwargs: Dict[str, Any]):
        ...
        self.observation_results = [
            v if isinstance(v, ObservationResultId) else ObservationResultId(v) for v in self.observation_results
        ]
...
class DataLayoutSection(NamedThing):
    ...
    elements: Optional[
        Union[
            Dict[Union[str, DataLayoutElementId], Union[dict, "DataLayoutElement"]],
            List[Union[dict, "DataLayoutElement"]],
        ]
    ] = empty_dict()
...
slots.elements = Slot(
    ...
    range=Optional[
        Union[
            Dict[Union[str, DataLayoutElementId], Union[dict, DataLayoutElement]], List[Union[dict, DataLayoutElement]]
        ]
    ],
)
