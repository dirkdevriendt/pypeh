...
CLASS_REFERENCES = {
    ...
    "QUDTUnitId": peh.QUDTUnit,
    "BioChemEntityId": peh.BioChemEntity,
    "BioChemEntitySubClassId": peh.BioChemEntitySubClass,
    "MatrixId": peh.Matrix,
    "MatrixSubClassId": peh.MatrixSubClass,
    "IndicatorId": peh.Indicator,
    "IndicatorSubClassId": peh.IndicatorSubClass,
    ...
    "ObservationDesignId": peh.ObservationDesign,
